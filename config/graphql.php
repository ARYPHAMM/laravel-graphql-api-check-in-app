...
return [
    ...
    // parameter.
    'default_schema' => 'user', //or default;
    ...
    'schemas' => [
        ...
        'user' => [
            'query' => [
                'paginateCheckIns' => App\GraphQL\Queries\PaginateCheckInsQuery::class,
                'paginateUsers' => App\GraphQL\Queries\PaginateUsersQuery::class,
                'login' => App\GraphQL\Queries\LoginQuery::class,
                'user' => App\GraphQL\Queries\UserQuery::class,
                'users' => App\GraphQL\Queries\UsersQuery::class,
                'CheckIns' => App\GraphQL\Queries\CheckInsQuery::class,
            ],
            'mutation' => [
                // Create a user
                'createUser' => App\GraphQL\Mutations\CreateUserMutation::class,
                ...
                'updateUserCurrent' => App\GraphQL\Mutations\UpdateUserCurrentMutation::class,
                // delete a user
                'deleteUser' => App\GraphQL\Mutations\DeleteUserMutation::class,
                // create a checkin
                'createCheckIn' => App\GraphQL\Mutations\CreateCheckInMutation::class,
    ...
    'types' => [
        ...
        'CheckIn' => App\GraphQL\Types\CheckInType::class,
        // ExampleType::class,
